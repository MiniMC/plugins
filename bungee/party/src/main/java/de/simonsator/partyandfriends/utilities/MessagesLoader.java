...
public class MessagesLoader extends LanguageConfiguration {
	...
	private void loadEnglishMessages() {
		...
		set("Party.CommandUsage.Join", "&8/&7Party join  &8- &7Join a party");
		set("Party.CommandUsage.Deny", "&8/&7Party deny  &8- &7Deny a party invitation");
		set("Party.CommandUsage.Invite", "&8/&7Party invite  &8- &7Invite a player into your party");
		set("Party.CommandUsage.InviteSetting", "&8/&7Party setting  &8- &7Enables/disables party invites");
		set("Party.CommandUsage.List", "&8/&7Party list &8- &7List all players who are in the party");
		set("Party.CommandUsage.Chat", "&8/&7Party chat  &8- &7Send all players in the party a message");
		set("Party.CommandUsage.Leave", "&8/&7Party leave &8- &7Leave the party");
		set("Party.CommandUsage.Kick", "&8/&7Party kick  &8- &7Kicks a player out of the party");
		set("Party.CommandUsage.Leader", "&8/&7Party leader &7 &8- &7Makes another player to the party leader");
		set("Party.Command.General.ErrorNoParty", "&7You need to be in a party.");
		...
		set("Party.Command.General.DissolvedPartyCauseOfNotEnoughPlayers", "&7The party was dissolved because there are not enough players.");
		...
		set("Party.Command.Chat.ErrorNoMessage", "&7You need to give in a message.");
		...
		set("Party.Command.Invite.YouWereInvitedBY", "&7You were invited into &6[PLAYER]'s &7party!");
		...
		set("Party.Command.Invite.InvitationTimedOutInvited", "&7The invitation of &6[PLAYER]'s &7party is timed out!");
		set("Party.Command.Invite.InvitationTimedOutLeader", "&7The player &6[PLAYER] &7has not accepted your invitation!");
		...
		set("Friends.CommandUsage.List", "&8/&7friend list &8- &7Lists all your friends");
		set("Friends.CommandUsage.MSG", "&8/&7friend msg [name of the friend] [message]&r &8- &7Send a message to a friend");
		set("Friends.CommandUsage.ADD", "&8/&7friend add [name of the player]&r &8- &7Add a friend");
		set("Friends.CommandUsage.Accept", "&8/&7friend accept [name of the player]&r &8- &7Accept a friend request");
		set("Friends.CommandUsage.Deny", "&8/&7friend deny [name of the player]&r &8- &7Deny a friend request");
		set("Friends.CommandUsage.Remove", "&8/&7friend &7remove &7[name &7of &7the &7friend]&r &8- &7Removes &7a &7friend");
		set("Friends.CommandUsage.Jump", "&8/&7friend jump [name of the friend]&r &8- &7Jump to a friend");
		set("Friends.CommandUsage.Settings", "&8/&7friend settings &r&8- &7Change the settings");
	...
	private void loadGermanMessages() {
		...
		set("Friends.CommandUsage.List", "&8/&7friend list&r &8- &7Listet deine Freunde auf");
		set("Friends.CommandUsage.MSG", "&8/&7friend msg [Name des Freundes] [Nachricht]&r &8- &7schickt einem Freund eine private Nachricht");
		set("Friends.CommandUsage.ADD", "&8/&7friend add [Name des Spielers]&r &8- &7Fügt einen Freund hinzu");
		set("Friends.CommandUsage.Accept", "&8/&7friend accept [Name des Spielers]&r &8- &7Akzeptiert eine Freundschaftsanfrage");
		set("Friends.CommandUsage.Deny", "&8/&7friend deny [Name des Spielers]&r &8- &7Lehnt eine Freundschaftsanfrage ab");
		set("Friends.CommandUsage.Remove", "&8/&7friend remove [Name des Spielers]&r &8- &7Entfernt einen Freund");
		set("Friends.CommandUsage.Jump", "&8/&7friend jump [Name des Freundes]&r&8- &7Zu einem Freund springen");
		set("Friends.CommandUsage.Settings", "&8/&7friend settings &r&8- &7Ändere die Einstellungen");
		...
		set("Party.CommandUsage.Join", "&8/&7Party join <Name> &8- &7Trete einer Party bei");
		set("Party.CommandUsage.Deny", "&8/&7Party deny  &8- &7Lehne eine Einladung ab");
		set("Party.CommandUsage.Invite", "&8/&7Party invite <Name> &8- &7Lade einen Spieler in deine Party ein");
		set("Party.CommandUsage.InviteSetting", "&8/&7Party setting  &8- &7Aktiviert/deaktiviert Party Einladungen");
		set("Party.CommandUsage.List", "&8/&7Party list &8- &7Listet alle Spieler in der Party auf");
		set("Party.CommandUsage.Chat", "&8/&7Party chat <Nachricht> &8- &7Sendet allen Spieler in der Party eine Nachicht");
		set("Party.CommandUsage.Leave", "&8/&7Party leave &8- &7Verlässt die Party");
		set("Party.CommandUsage.Kick", "&8/&7Party kick <Spieler> &8- &7Kickt einen Spieler aus der Party");
		set("Party.CommandUsage.Leader", "&8/&7Party leader <Spieler> &8- &7Macht einen anderen Spieler zum Leader");
		...
		set("Party.Command.General.DissolvedPartyCauseOfNotEnoughPlayers", "&7Die Party wurde wegen zu wenig Mitgliedern aufgelöst.");
		set("Party.Command.General.ServerSwitched", "&bDie Party hat den Server &e[SERVER] &bbetreten.");
		set("Party.Command.Chat.ErrorNoMessage", "&7Du musst eine Nachricht eingeben.");
		...
		set("Party.Command.Invite.InvitationTimedOutInvited", "&7Die Einladung in die Party von &6[PLAYER] &7ist abgelaufen!");
		set("Party.Command.Invite.InvitationTimedOutLeader", "&7Der Spieler &6[PLAYER] &7hat die Einladung nicht angenommen!");
		...
		set("Party.Command.Invite.DeclineInvite",
				"&cLehne die Einladung mit &6/Party &6deny &6[PLAYER]&7 &cab!");
		...
		set("Party.Command.Invite.YouWereInvitedBY",
				"&7Du wurdest in die Party von &6[PLAYER] &7eingeladen!");
	}

	private void loadSharedMessages() {
		set("Friends.General.Prefix", "&bFriends &8&l>> &r&7");
		set("Party.General.PartyPrefix", "&bParty &8&l>> &r&7");
		set("Friends.General.HelpBegin",
				"&8&m-------------------&r&8[&7&lFriends&8]&m-------------------");
		set("Friends.General.HelpEnd", "&8&m-----------------------------------------------");
		set("Party.General.HelpBegin",
				"&8&m-------------------&r&8[&7&lParty&8]&m-------------------");
		set("Party.General.HelpEnd", "&8&m---------------------------------------------");
		set("Party.Command.Chat.Prefix", "&bParty Chat &8&l>> &r&7");
		set("Party.Command.Chat.ContentColor", "&7");
		set("Party.Command.Chat.PartyChatOutput", "&e[SENDERNAME]&7:[MESSAGE_CONTENT]");
		set("Party.Command.Info.PlayersCut", "&7, &b");
		set("Party.Command.Info.Leader", "&3Leader&7: &7[LEADER]");
		...
		set("Friends.Command.MSG.SentMessage", " &e[SENDERNAME] &7-> &e[PLAYER]&7:[CONTENT]");
