...
public class AddArenaWallSubCommand extends TheWallsSubCommand {
	...
	public void execute(CommandSender sender, String label, String[] args) {
		...
		try {
			...
			player.sendMessage(plugin.addPrefix(ChatColor.GRAY + "The cuboid region you have selected has been added to the list of wall regions for " + ChatColor.GRAY + arena.getName()));
