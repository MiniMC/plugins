	...
	public void execute(CommandSender sender, String label, String[] args) {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				arena.broadcast(ChatColor.GREEN + player.getDisplayName() + ChatColor.GRAY + " has left the game voluntarily (" + ChatColor.GOLD + arena.getPlayers().size() + ChatColor.GRAY + ")");
			}
		};
