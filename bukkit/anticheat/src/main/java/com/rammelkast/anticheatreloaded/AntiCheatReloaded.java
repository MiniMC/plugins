...
public final class AntiCheatReloaded extends JavaPlugin {
	...
	public static final String PREFIX = ChatColor.AQUA + "System "+ ChatColor.DARK_GRAY + ChatColor.BOLD + ">> " + ChatColor.GRAY + ChatColor.RESET + ChatColor.GRAY;
